...
Design changes
- added marshmallow to help validate requests
- tried to reuse code
...
- use a default range of past 1 hour since database will have a ton of records
- use maximum time range of 6 months maybe

- maybe using timescale db for this will be better. 